<template>
  <div class='metamask-info'>
    ...
    <p v-if="userInfo && userInfo.firstname">User Info: {{ userInfo.firstname }} {{ userInfo.lastname}} {{ userInfo.role}}</p>
    <p v-if="userInfo && userInfo.firstname">Organization: {{ userInfo.organization.name }}</p>
  </div>
</template>
